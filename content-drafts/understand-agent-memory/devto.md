...
published: false
description: "Agent memory is not just chat history. I break it into four layers: conversation history, knowledge, skills, and the context harness around them."
tags: ai, agents, rag, productivity
cover_image: https://zc277584121.github.io/images/understand-agent-memory/agent-memory-types.png
canonical_url: https://zc277584121.github.io/ai-agent/2026/06/22/understand-agent-memory.html
---
